...
const NFT = styled(Paper)`
  ...
  flex: 1 1 auto;
  background-color: #9bf3ca8f !important;
      ...
      <MainContainer>
        <WalletContainer>
          ...
          <Menu>
            ...
            <li>
              <a
                href="https://twitter.com/Kawaii__Zoo/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Twitter
            ...
            <li>
              <a
                href="https://discord.gg/TWaN7JZD7p"
                target="_blank"
                rel="noopener noreferrer"
              >
                Discord
          ...
          <DesContainer>
            <NFT elevation={3}>
              ...
              <div>
                ...
                />
                <Image src="logo.png" alt="NFT To Mint" />
              </div>
              <br />
              {wallet &&
                isActive &&
